...
'''Points to be noted from this:
1)used variables 4(1 sting, 1temp list,1reversed list,1 reversed sentence)
2)Used slicing technique using [::-1} to reverse string
'''
